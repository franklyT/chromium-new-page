...
const greetingsList = {
    ...
    wildcard: [`Hi there ${name}.`, `Hey, ${name}.`, `What's up, ${name}?`, `Greetings, ${name}!`, `Salute, ${name}.`, `Howdy, ${name}.`,
                `Yo, ${name}!`, `Good day, ${name}.`, `Hello, ${name}.`, `Hi, ${name}.`, `How are things, ${name}?`,
                `How's it going, ${name}?`, `Sup', ${name}?`, `What's new, ${name}?`, `Well, hello, ${name}.`, `Hey, what's up, ${name}?`,
